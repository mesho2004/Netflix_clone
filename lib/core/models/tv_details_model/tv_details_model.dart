...
class TvDetailsModel {
  ...
  factory TvDetailsModel.fromMap(Map<String, dynamic> data) {
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [TvDetailsModel].
  factory TvDetailsModel.fromJson(String data) {
    return TvDetailsModel.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [TvDetailsModel] to a JSON string.
